...
import de.jungierek.grblrunner.preference.AppearancePreferencePage;
...
import de.jungierek.grblrunner.preference.HistoryPreferencePage;
...
public class PreferencesCommandHandler {
    ...
    public void execute ( Shell shell ) {
        ...
        preferenceManager.addToRoot ( new PreferenceNode ( AppearancePreferencePage.ID, new AppearancePreferencePage ( preferenceStore ) ) );
        ...
        preferenceManager.addToRoot ( new PreferenceNode ( HistoryPreferencePage.ID, new HistoryPreferencePage ( preferenceStore ) ) );
