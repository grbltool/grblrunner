...
public class MacroPreferencPage extends FieldEditorPreferencePage {
    ...
    public static final String ID = IConstants.KEY_BASE + ".macro";
    ...
    protected void createFieldEditors () {
        ...
        addField ( new DoubleFieldEditor ( IPreferenceKey.MACRO_Z_LIFTUP, "z liftup (mm)", 0.0, IConstants.PREFERENCE_DOUBLE_MAX, getFieldEditorParent () ) );
