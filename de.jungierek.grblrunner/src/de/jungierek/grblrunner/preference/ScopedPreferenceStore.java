...
public class ScopedPreferenceStore extends EventManager implements IPreferenceStore, IPersistentPreferenceStore {
    ...
    /**
     * The storeContext is the context where values will stored with the setValue methods. If there are no searchContexts this will be the search context. (along with the "default"
     * context)
     */
    ...
    /**
     * The default context is the context where getDefault and setDefault methods will search. This context is also used in the search.
     */
    ...
    /**
     * Create a new instance of the receiver. Store the values in context in the node looked up by qualifier. <strong>NOTE:</strong> Any instance of ScopedPreferenceStore should
     * call
     * 
     * @param context
    ...
    private void initializePreferencesListener () {
        if ( preferencesListener == null ) {
            preferencesListener = new IEclipsePreferences.IPreferenceChangeListener () {
                 ...
                 * 
                 * @see
                 * org.eclipse.core.runtime.preferences.IEclipsePreferences.IPreferenceChangeListener#preferenceChange(org.eclipse.core.runtime.preferences.IEclipsePreferences.
    ...
    /**
     * Does its best at determining the default value for the given key. Checks the given object's type and then looks in the list of defaults to see if a value exists. If not or
     * if there is a problem converting the value, the default default value for that type is returned.
     * 
     * @param key
     *            the key to search
     * @param obj
    ...
    /**
     * Return the preference path to search preferences on. This is the list of preference nodes based on the scope contexts for this store. If there are no search contexts set,
     * then return this store's context.
     * <p>
    ...
    /**
     * Set the search contexts to scopes. When searching for a value the seach will be done in the order of scope contexts and will not search the storeContext unless it is in this
     * list.
     * <p>
     * If the given list is <code>null</code>, then clear this store's search contexts. This means that only this store's scope context and default scope will be used during
     * preference value searching.
     * </p>
     * <p>
    ...
    /**
     * Return the string value for the specified key. Look in the nodes which are specified by this object's list of search scopes. If the value does not exist then return
     * <code>null</code>.
     * 
     * @param key
