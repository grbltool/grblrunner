...
//from https://github.com/reedcourty/denafutsal/blob/master/hu.bme.mit.inf.mdsd.one.app/src/org/eclipse/wb/swt/DoubleFieldEditor.java
...
public class DoubleFieldEditor extends StringFieldEditor {
     ...
     *            the parent of the field editor's control
     */
    public DoubleFieldEditor ( String name, String labelText, double min, double max, Composite parent ) {
        this ( name, labelText, parent, DEFAULT_TEXT_LIMIT );
