...
public interface IGcodeService {
    ...
    public static final String [] [] ALARM_CODE_DESCRIPTION = new String [] [] {

        /* @formatter:off */
        /* 0 */ { "No alarm descritpion found" },
        /* 1 */ { "Hard limit triggered.", "Machine position is likely lost due t }o sudden and immediate halt.", "Re-homing is highly recommended." }, 
